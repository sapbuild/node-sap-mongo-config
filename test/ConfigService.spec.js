...
//     var configDb;
//     var badDb = new MockDb({ failOnCollection: true });
...
//         return DbHelper.connect('mongodb://localhost:27017/mongo-config-test')
...
//             var configService = ConfigService.create(badDb);
...
//         });
//         it('should handle database errors', function (done) {
//             var configService = ConfigService.create(mockDb);
//             configService.getConfig('testConfig')
//                 .then(preventOnFulfilled, function () {
//                 })
//                 .then(testPassed(done), testFailed(done));
...
//         it('should handle database errors', function (done) {
//             var configService = ConfigService.create(mockDb);
//             configService.set('testFail', 'foo')
//                 .then(preventOnFulfilled, function () {
//                 })
//                 .then(testPassed(done), testFailed(done));
//         });
...
//                 })
//                 .then(function (oldConfig) {
//                     expect(oldConfig._id).to.equal('test-delete');
//                     expect(oldConfig.value).to.deep.equal(testConfig);
//                     return configService.get('test-delete');
//                 })
//                 .then(function (value) {
...
//             var configService = ConfigService.create(configDb.db);
//             configService.delete('unknown-key')
//                 .then(function (oldConfig) {
//                     expect(oldConfig).to.be.null;
//                 })
//                 .then(testPassed(done), testFailed(done));
